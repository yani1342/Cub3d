...
static void	free_mlx(t_data *data)
{
	...
	if (data->map.so_tex.img_ptr)
		mlx_destroy_image(data->mlx_ptr, data->map.so_tex.img_ptr);
	if (data->map.we_tex.img_ptr)
		mlx_destroy_image(data->mlx_ptr, data->map.we_tex.img_ptr);
	if (data->map.ea_tex.img_ptr)
